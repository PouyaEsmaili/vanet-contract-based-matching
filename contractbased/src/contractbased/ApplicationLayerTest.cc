...
#include "contractbased/ApplicationLayerTest.h"

#include "contractbased/ApplicationLayerTestMessage_m.h"

using namespace veins;
using namespace contractbased;

Define_Module(contractbased::ApplicationLayerTest);
